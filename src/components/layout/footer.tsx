...
export default function Footer({ config }: FooterProps) {
  if (!config) {
    return (
      <footer className="bg-muted/40 text-muted-foreground py-8 mt-12 border-t border-border">
  ...
  return (
    <>
      <footer className="bg-muted/40 text-muted-foreground pt-12 pb-8 mt-12 border-t border-border">
