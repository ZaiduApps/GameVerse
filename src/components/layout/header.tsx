          ...
          <Dialog open={loginDialogOpen} onOpenChange={setLoginDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              ...
              <DialogFooter className="flex-col space-y-2 sm:flex-col sm:space-y-2 sm:space-x-0">
                <Button type="submit" className="w-full btn-interactive" onClick={() => {alert('登录操作 (模拟)'); setLoginDialogOpen(false);}}>登录</Button>
                <Button type="button" variant="outline" className="w-full" onClick={() => {alert('注册操作 (模拟)'); setLoginDialogOpen(false);}}>还没有账户？立即注册</Button>
                ...
                <div className="grid grid-cols-2 gap-3">
                   <Button variant="outline" className="btn-interactive">
                    {/* Placeholder for a social icon e.g. Google */}
                  ...
                  <Button variant="outline" className="btn-interactive">
                    {/* Placeholder for another social icon e.g. GitHub */}
